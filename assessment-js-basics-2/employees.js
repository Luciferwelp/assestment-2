...
//CODE HERE
const empOne = new Employee("jess")
empOne.getName();
/*
    Call the `getSchedule` method on the
    `empOne` object.
*/
let shifts = "Weekday mornings, weekdays afternoons"
empOne.getSchedule("Weekday mornings, weekdays afternoons")
//CODE HERE
